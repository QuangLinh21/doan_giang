...
@section('content')
    <div class="col-md-12">
        ...
        @endif
        <form method="post" role="form" action="{{ URL::to('add-brand') }}">
            @csrf
            <div>
                <div class="mb-3">
                    <label for="namecategory" class="form-label">Tên thương hiệu</label>
                    <input type="name" class="form-control" required name="name_brand" id="namecategory">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Mô tả</label>
                    <textarea class="form-control" required  id="ckeditor_cate" name="description" rows="3"></textarea>
                </div>
                <div class="mb-3">
