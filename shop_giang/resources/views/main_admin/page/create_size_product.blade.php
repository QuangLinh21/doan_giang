...
@section('content')
    <div class="col-md-12">
        ...
        @endif
        <form method="post" role="form" action="{{ URL::to('add-size') }}">
            @csrf
            <div>
                <div class="mb-3">
                    <label for="namecategory" class="form-label">Size</label>
                    <input type="name" class="form-control" required name="size" id="namecategory">
                </div>
                <div class="mb-3">
