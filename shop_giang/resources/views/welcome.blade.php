...
<![endif]-->
    ...
    <main class="main-wrapper">
       ...
       {{-- @include('user_page.layout.banner-home') --}}
        ...
        <!-- Start Testimonila Area feedback  -->
                ...
                <div class="row">
                    <div class="col-lg-6 mb--30">
                        <div class="single-poster">
                            <a href="shop.html">
                                <img src="{{URL::to('../public/frontend/assets/images/product/poster/poster-01.png')}}" alt="eTrade promotion poster">
                    ...
                    <div class="col-lg-6 mb--30">
                        <div class="single-poster">
                            <a href="shop-sidebar.html">
                                <img src="{{URL::to('../public/frontend/assets/images/product/poster/poster-02.png')}}" alt="eTrade promotion poster">
            ...
            <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 row--20">
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src=" {{URL::to('../public/frontend/assets/images/icons/service1.png')}}" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="{{URL::to('../public/frontend/assets/images/icons/service2.png')}}" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="{{URL::to('../public/frontend/assets/images/icons/service3.png')}}" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="{{URL::to('../public/frontend/assets/images/icons/service4.png')}}" alt="Service">
                        </div>
                        <div class="content">
