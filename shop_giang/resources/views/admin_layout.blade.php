...
<head>
    ...
    <link rel="stylesheet" href="{{asset('../public/backend/css/bootstrap1.min.css')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/css/metisMenu.css')}}">
    <link rel="stylesheet" href="{{asset('../public/backend/css/style1.css')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/themefy_icon/themify-icons.css ')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/niceselect/css/nice-select.css')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/owl_carousel/css/owl.carousel.css')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/gijgo/gijgo.min.css')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/font_awesome/css/all.min.css')}}"/>>
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/tagsinput/tagsinput.css')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/datepicker/date-picker.css ')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/scroll/scrollable.css')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/datatable/css/jquery.dataTables.min.css')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/datatable/css/responsive.dataTables.min.css ')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/datatable/css/buttons.dataTables.min.css ')}}" />
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/text_editor/summernote-bs4.css ')}}" />
    <link rel="stylesheet" href=" {{asset('../public/backend/vendors/morris/morris.css')}}">
    <link rel="stylesheet" href="{{asset('../public/backend/vendors/material_icon/material-icons.css ')}}" />
    <title>Document</title>
</head>
<body class="crm_body_bg">
    {{-- -------------------sidebar---------------------- --}}
    @include('main_admin.layout.sidebar')
     {{-- -------------------sidebar---------------------- --}}
     <section class="main_content dashboard_part large_header_bg">
        @include('main_admin.layout.header')
       ...
       @include('main_admin.layout.footer')
    </section>
    ...
    <script src="{{asset('../public/backend/js/bootstrap1.min.js')}}"></script>
    <script src="{{asset('../public/backend/js/jquery1-3.4.1.min.js')}}"></script>
    ...
    <script>
     ...
     <script>
		ClassicEditor
		.create(document.querySelector('#ckeditornew'))
		.catch(error=>{
			console.error(error);
		})
