<div class="modal fade quick-view-product" id="xemnhanh" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 order-lg-1">
                                    <div class="product-small-thumb small-thumb-wrapper">
                                        <div class="small-thumb-img" id="product_quickview_img1">
                                            {{-- <img src="assets/images/product/product-thumb/thumb-08.png" alt="thumb image"> --}}
                                        </div>
                                        <div class="small-thumb-img" id="product_quickview_img2">
                        ...
                        <div class="col-lg-5 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    ...
                                    <h3 class="product-title" id="product_quickview_name">Serif Coffee Table</h3>
                                    <span class="price-amount" id="product_quickview_price">$155.00 - $255.00</span>
